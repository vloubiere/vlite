...
#' @param col A vector of colors corresponding to the values in breaks. If set to NULL (default),
...
#' @param xlim Numeric vector of length 2 giving x-axis limits. Default= c(0.5, ncol(mat) + 0.5).
#' @param ylim Numeric vector of length 2 giving y-axis limits. Default= c(nrow(mat) + 0.5, 0.5).
...
#' @param xlab Character string for the x-axis label. Default= NA.
#' @param ylab Character string for the y-axis label. Default= NA.
#' @param na.col Color to use for NA values. Default is "lightgrey".
#' @param show.numbers Logical or matrix; if TRUE or a matrix is provided, displays values in cells. Default= FALSE.
#' @param numbers.cex Numeric scaling factor for the size of numbers when show.numbers is se to TRUE. Default= 0.8.
