setwd("/zssd/scratch/vincent.loubiere/vlite/")
devtools::load_all("./")
...
## Submit jobs ----
### Cavalli server
file.edit("R/submitCav.R") # Cavalli server
### SLURM wrappers
...
## Genomics pipelines general function ----
### Helper functions
...
## Plotting methods enrichment analyses ----
...
## bedtools ----
file.edit("R/enrichBed.R") # Assess whether the overlap between two set of regions is significantly larger than expected
